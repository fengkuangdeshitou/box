...
- (void)layoutSubviews
{
    ...
    self.titleLabel.center = CGPointMake(centerOfView, centerOfTitleLabel-5);
...
+(instancetype)publishButton{
    ...
    [button setBackgroundImage:[UIImage imageNamed:[MyNewMaterialInfo shareInstance].isShowMaterial == NO ? @"Table栏icon" : [MyNewMaterialInfo shareInstance].home_menu_center_icon] forState:UIControlStateNormal];

    [button setTitleColor:[UIColor grayColor] forState:UIControlStateNormal];
    button.titleLabel.font = [UIFont systemFontOfSize:9.5];
    
    [button sizeToFit];
//    button.frame = CGRectMake(0, 0, 61, 59);
    button.frame = CGRectMake(0, 0, 78, 80);
...
- (void)clickPublish {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"kPublishBtnPress" object:nil];
