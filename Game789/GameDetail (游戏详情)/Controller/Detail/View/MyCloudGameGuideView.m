//
//  MyCloudGameGuideView.m
//  Game789
//
//  Created by Maiyou001 on 2021/6/22.
//  Copyright © 2021 yangyong. All rights reserved.
//

#import "MyCloudGameGuideView.h"

@implementation MyCloudGameGuideView
...
- (void)configInterFace
{
    ...
    imageView4.image = [UIImage imageNamed:@"home_guide_page_point_right"];
    [guideView1 addSubview:imageView4];

    UIImageView * imageView3 = [[UIImageView alloc] init];
    imageView3.image = [UIImage imageNamed:@"cloud_game_tip"];
    ...
    imageView7.image = [UIImage imageNamed:@"cloud_game_tip1"];
    [guideView1 addSubview:imageView7];
...
//    guideView1.frame = CGRectMake(CGRectGetMidX(self.views.lastObject.frame) - 212 / 2, CGRectGetMinY(self.views.lastObject.frame) - 90 - 8, 212, 90);
    ...
    imageView4.frame = CGRectMake(view1.x - 10 - 83, view1.y + view1.height / 2, 83, 59);
    imageView3.frame = CGRectMake((kScreenW - 260.5) / 2, CGRectGetMaxY(imageView4.frame) + 10, 260.5, 63);
    imageView6.frame = CGRectMake((kScreenW - 161.5) / 2, CGRectGetMaxY(imageView3.frame) + 40, 161.5, 70);
    imageView7.frame = CGRectMake((kScreenW - 250.5) / 2, CGRectGetMaxY(imageView6.frame) + 20, 250.5, 26.5);
