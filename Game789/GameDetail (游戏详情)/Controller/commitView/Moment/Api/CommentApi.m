...
@implementation GetCommentDetailApi
...
- (NSString *)requestURL {
    return @"base/comment/getCommentDetail";
}
...
- (NSString *)requestURL {
    return @"base/comment/getCommentListForComment";
}
...
- (NSString *)requestURL {
    return @"base/comment/likeComment";
}
...
@implementation CommentForCommentApi
...
- (NSString *)requestURL {
    return @"base/comment/commentForComment";
}
