...
@interface Avatar :MyBaseModel
@property (nonatomic , copy) NSArray<NSString *>              * url_list;
@property (nonatomic , copy) NSString              * uri;
@end

@interface Policy_version :MyBaseModel
@end

@interface Url_list :MyBaseModel
@end

@interface Video_icon :MyBaseModel
@property (nonatomic , copy) NSArray<Url_list *>               * url_list;
@property (nonatomic , copy) NSString              * uri;

@end

@interface Geofencing :MyBaseModel
@end

@interface Activity :MyBaseModel
