...
CGFloat kMarginContentLeft    = 15; //动态内容左边边距
CGFloat kMarginContentRight   = 15; //动态内容右边边边距
...
- (void)setup{
    ...
    self.labelName.textColor = [UIColor colorWithHexString:@"#303030"];
    [self.contentView addSubview:self.labelName];
    
    self.labelIndustry = [UILabel new];
    self.labelIndustry.font = [UIFont systemFontOfSize:12.0f];
    self.labelIndustry.textColor = [UIColor colorWithHexString:@"#303030"];
    ...
    [self.contentView addSubview:self.labelContent];
     ...
     self.labelDelete.textColor = MYColor(61, 95, 155);
     ...
     self.labelMore.textColor = MYColor(0, 191, 143);
    ...
    self.picContainerView = [[YHWorkGroupPhotoContainer alloc] initWithWidth:SCREEN_WIDTH-20];
     ...
     self.viewSeparator.backgroundColor = MYColor(244, 244, 244);
