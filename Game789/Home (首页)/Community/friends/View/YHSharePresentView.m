...
#define kPopViewBGColor MYColor(224.0f, 224.0f, 224.0f)       //collectionView背景颜色
#define kMaskBGColor [MYColor(0, 0, 0) colorWithAlphaComponent:0.5] //遮罩背景颜色
#define kTextColor [UIColor blackColor]
#define kCancelBtnColor MYColor(0.f, 191.0f, 143.f)
