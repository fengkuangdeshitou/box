...
@implementation GoldMallRequestAPI
...
- (id)requestParameters
{
    ...
    params[@"type"] = self.voucherType;
    params[@"id"] = self.voucherId;
...
@implementation GoldMallAPI : BaseRequest
...
- (NSString *)requestURL {
    return @"GoldCoinMall/getIndexData";
}
