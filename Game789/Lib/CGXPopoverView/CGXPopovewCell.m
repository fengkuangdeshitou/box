...
float const CGXPopovewCellTitleLeftEdge = 35.f; ///< 标题左边边距
float const CGXPopovewCellImageLeftEdge = 10.f; ///< 标题左边边距
...
- (void)setAction:(CGXPopoverItem *)action {
    ...
    if (action.image) {
        ...
        self.button.imageEdgeInsets = UIEdgeInsetsMake(0, CGXPopovewCellImageLeftEdge, 0, 0);
    }
