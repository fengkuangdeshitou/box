...
{
    [self jxt_showAlertWithPreferredStyle:UIAlertControllerStyleAlert title:title.localized message:message.localized appearanceProcess:appearanceProcess actionsBlock:actionBlock];
}
