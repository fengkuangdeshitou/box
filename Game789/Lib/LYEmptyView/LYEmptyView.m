...
//描述字体
#define kTitleLabFont [UIFont systemFontOfSize:14.f]

//详细描述字体
#define kDetailLabFont [UIFont systemFontOfSize:12.f]
...
//灰色
#define kGrayColor [UIColor colorWithRed:101/255.0 green:101/255.0 blue:101/255.0 alpha:1.0]
...
- (void)setSubViewFrame{
    ...
    self.center = CGPointMake(emptyViewCenterX, emptyViewCenterY - 20);
