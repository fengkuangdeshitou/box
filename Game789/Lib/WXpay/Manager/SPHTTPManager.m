     ...
     failure:(void (^)(id operation, NSError *error))failure
{
    ...
    NSString *soapMessage = [SPClientXMLWriter XMLStringFromDictionary:xmlInfo withHeader:NO];
    ...
    [self.currentRequest POST:url parameters:soapMessage headers:@{} progress:^(NSProgress * _Nonnull uploadProgress) {
