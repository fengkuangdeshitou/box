//
//  JSPatch.h
//  JSPatch Platform SDK version 1.8.2
//
...
#define JSPatch Eedode
#define startWithAppKey rankMost
#define setupRSAPublicKey programKey
#define setupTestScriptFileName manifestName
#define updateConfigWithAppKey explicitKey
#define testScriptInBundle deadTest
#define JPCallbackType jtspc_b
#define JPErrorCode DRkcos
#define setupCallback sefjtpsytecal

#define setupLogger wREcEh
#define setupUserData IWKkXt
#define setupDevelopment eidkmc
#define showLog xJMQfK
#define setupUpdatedConfigCallback IfMnXQ

#define JPCallbackTypeUnknow siwof0
#define JPCallbackTypeRunScript siwof1
#define JPCallbackTypeUpdate siwof2
#define JPCallbackTypeUpdateDone siwof3
#define JPCallbackTypeCondition siwof4
#define JPCallbackTypeGray siwof5
#define JPCallbackTypeUpdateFail siwof6
#define JPCallbackTypeException siwof7
#define JPCallbackTypeJSException siwof8
#define JPErrorUntar siwof9
#define JPErrorUntarScript siwof10
#define JPErrorMD5NotMatch siwof11
#define JPErrorScriptFileMissing siwof12
#define JPErrorKeyFileMissing siwof13
#define JPErrorDecryptMd5 siwof14
#define JPErrorNetworkError siwof15
