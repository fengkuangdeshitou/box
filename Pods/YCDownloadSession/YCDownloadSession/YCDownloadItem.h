...
- (void)downloadItem:(nonnull YCDownloadItem *)item speed:(NSUInteger)speed speedDesc:(NSString *_Nullable)speedDesc;
@end
...
@property (nonatomic, copy, nonnull) NSString *downloadURL;
